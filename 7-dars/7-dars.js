...
// // sayHi() // fnc expression uzidan yuqorida chaqirib bulmaydi error beradi
// // error
...
// // =-=-=- return 
// // bu ham consolga uxshab malumot qaytarib beradi (chiqrb)
// // faqat bundan qaytayotgan qiymat ustida yana boshqa amal bajarsak buladi 
// // Misol: Imtihin baholarini foizga utgazim yaxlitlangan holda chiqarish 
...
// }
// // age(2,2)
// // console.log(age(2.2,2.98) + 2) // undefined + 2 = NaN
// console.log(parseInt(age(2.2,2.98))) // 
...
// // console.log(getGpa(2.6, 3.5, 4, 2.3, 5) * 2) // value: NaN - chiqardi return urniga consol bulganda


// // -=-=-=-=-=-=-= verable shadow
// // verable fnc ichida bulsa inner verable tashqarisida bulsa outer verable diyaladi
